...
internal sealed class RuleEditorStrings
{
    ...
    private static RuleEditorStrings SimplifiedChinese { get; } = new()
    {
        ...
        DisplayValueWarning = "Catalyst、品质或特殊效果可能改变 tooltip 显示值。这里的数值约束只比较屏幕上实际显示的值，不推算装备的基础值。",
        AcceptableResultsHeading = "可接受结果",
        OrExplanation = "结果之间为 OR（或）关系",
        ...
        TemplateHelp = "粘贴完整词缀，不使用关键词或子串；数值槽会自动识别。",
        ...
        NoNumericSlots = "没有检测到数值槽；此条件将按完整文字匹配。",
        NumericSlotsFoundFormat = "检测到 {0} 个数值槽。约束顺序与词缀中的数值顺序一致。",
        SlotLabelFormat = "数值槽 {0} · {1}",
        ...
        InvalidNumberFormat = "{0} 的数值槽 {1}：{2}不是有效数值。",
        RangeOrderErrorFormat = "{0} 的数值槽 {1}：最小值不能大于最大值。",
        AnyMode = "命中任意 1 条",
        AllMode = "命中全部",
        AtLeastMode = "至少命中 N 条",
        IgnoreMode = "忽略数值",
        RangeMode = "范围（含边界）",
    ...
    private static RuleEditorStrings English { get; } = new()
    {
        ...
        DisplayValueWarning = "Catalysts, quality, and special effects can change tooltip values. Numeric constraints compare only the value currently displayed on screen; they do not infer a base value.",
        AcceptableResultsHeading = "Acceptable results",
        OrExplanation = "Results are combined with OR",
        AddResult = "+ Add another acceptable result",
        DeleteResult = "Delete result",
        ResultNameLabel = "Result name",
        GroupModeLabel = "Within this result",
        ...
        TemplateHelp = "Paste the complete affix. Keywords and substrings are not used; numeric slots are detected automatically.",
        ...
        NoNumericSlots = "No numeric slots detected; this condition will match the complete text.",
        NumericSlotsFoundFormat = "Detected {0} numeric slot(s). Constraints follow the values' order in the affix.",
        SlotLabelFormat = "Numeric slot {0} · {1}",
        ...
        InvalidNumberFormat = "{0}, numeric slot {1}: {2} is not a valid number.",
        RangeOrderErrorFormat = "{0}, numeric slot {1}: the minimum cannot exceed the maximum.",
        AnyMode = "Match any one",
        AllMode = "Match all",
        AtLeastMode = "Match at least N",
